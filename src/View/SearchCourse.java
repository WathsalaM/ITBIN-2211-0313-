...
public class SearchCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(90, 140, 375, 184);
        ...
        jButton1.setBounds(490, 160, 114, 28);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel1.setText("Course Details");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(260, 10, 260, 42);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            while (r.next()){
                v = new Vector();
                v.add(r.getString("Course ID"));
                v.add(r.getString("course Name"));
